...
public class ScoreState extends State{
	...
	public void draw(Graphics g) {
		...
		Text.drawText(g, Constantes.SCORE, scorePos, true, Color.BLUE, Recursos.fontBig);
		Text.drawText(g, Constantes.DATE, datePos, true, Color.BLUE, Recursos.fontBig);
		...
		for(int i = auxArray.length - 1; i > -1; i--) {
			...
			Text.drawText(g, Integer.toString(d.getScore()), scorePos, true, Color.WHITE, Recursos.fontMed);
			Text.drawText(g, d.getDate(), datePos, true, Color.WHITE, Recursos.fontMed);
